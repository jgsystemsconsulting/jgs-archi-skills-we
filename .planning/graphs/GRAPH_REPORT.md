...
- `main()` --calls--> `pick_id()`  [INFERRED]
  docs\runs\moorfield\job01_build.py → docs\runs\job05_technology_physical.py
- `main()` --calls--> `pick_id()`  [INFERRED]
  docs\runs\moorfield\job01_fix_rels.py → docs\runs\job05_technology_physical.py
- `main()` --calls--> `pick_id()`  [INFERRED]
  docs\runs\moorfield\job01_place_layout.py → docs\runs\job05_technology_physical.py
- `main()` --calls--> `pick_id()`  [INFERRED]
  docs\runs\moorfield\job02_build.py → docs\runs\job05_technology_physical.py
- `ensure_element()` --calls--> `pick_id()`  [INFERRED]
  docs\runs\moorfield\job04_build.py → docs\runs\job05_technology_physical.py
...
- **Thin community `Community 12`** (2 nodes): `job01_fix_rels.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 13`** (2 nodes): `job01_build.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 14`** (2 nodes): `job01_place_layout.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
