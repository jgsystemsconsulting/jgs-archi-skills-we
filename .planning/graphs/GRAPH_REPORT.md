...
- `pick_id()` --calls--> `ensure_element()`  [INFERRED]
  docs\runs\job05_technology_physical.py → docs\runs\moorfield\job03_build.py
- `pick_id()` --calls--> `ensure_rel()`  [INFERRED]
  docs\runs\job05_technology_physical.py → docs\runs\moorfield\job03_build.py
- `pick_id()` --calls--> `main()`  [INFERRED]
  docs\runs\job05_technology_physical.py → docs\runs\moorfield\job03_build.py
- `pick_id()` --calls--> `ensure_element()`  [INFERRED]
...
Cohesion: 0.67
Nodes (5): ensure_element(), ensure_rel(), find_folder(), main(), search_exact()

### Community 10 - "Community 10"
Cohesion: 0.29
Nodes (4): main(), main(), main(), pick_id()
...
Cohesion: 0.83
Nodes (3): find_folder(), main(), search_exact()
...
- **Thin community `Community 14`** (2 nodes): `job04_finish.py`, `main()`
...
- **Why does `main()` connect `Community 0` to `Community 9`, `Community 10`, `Community 11`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `pick_id()` connect `Community 10` to `Community 0`, `Community 9`, `Community 11`, `Community 13`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `MCP` connect `Community 0` to `Community 9`?**
